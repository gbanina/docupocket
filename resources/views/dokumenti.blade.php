...
@section('content')
    ...
    <section id="dokumenti">
        ...
        <div class="documents-grid" id="documentsGrid">
            <article class="document-card" data-category="pdf" data-search="polica putnog osiguranja putovanje pdf" data-name="Polica putnog osiguranja" data-size="1800" data-date="20260714">
                <div class="file-icon">
                ...
                <div class="file-main">
                    <div class="title-row">
                        ...
                        <span class="shared-badge">Podijeljeno</span>
                    </div>
                    <div class="meta">
                        <span>PDF</span>
                        <span>1,8 MB</span>
                        <span>14. srpnja 2026.</span>
                    </div>
                </div>

                <div class="card-actions">
                    <button class="icon-button" type="button" onclick="showToast('Otvoren pregled dokumenta.')" aria-label="Pregled">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
                    </button>
                    <button class="icon-button share-trigger" type="button" data-item="Polica putnog osiguranja.pdf" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <button class="icon-button" type="button" onclick="showToast('Otvoreno uređivanje dokumenta.')" aria-label="Uredi">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 20h9"/>
            ...
            <article class="document-card" data-category="pdf" data-search="potvrda o prebivalištu adresa pdf" data-name="Potvrda o prebivalištu" data-size="620" data-date="20260708">
                <div class="file-icon">
                    <svg width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M7 3h7l4 4v14H7z"/>
                        <path d="M14 3v5h5"/>
                ...
                <div class="card-actions">
                    ...
                    <button class="icon-button share-trigger" type="button" data-item="Potvrda o prebivalištu.pdf" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="18" cy="5" r="3"/>
                            <circle cx="6" cy="12" r="3"/>
                            <circle cx="18" cy="19" r="3"/>
            ...
            <article class="document-card" data-category="docx" data-search="ugovor o najmu stan docx" data-name="Ugovor o najmu" data-size="84" data-date="20260701">
                ...
                <div class="file-main">
                    ...
                    <div class="meta">
                        <span>DOCX</span>
                        <span>84 KB</span>
                        <span>1. srpnja 2026.</span>
                    </div>
                </div>

                <div class="card-actions">
                    <button class="icon-button" type="button" onclick="showToast('Pokrenuto preuzimanje dokumenta.')" aria-label="Preuzmi">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 3v12"/>
                    ...
                    <button class="icon-button share-trigger" type="button" data-item="Ugovor o najmu.docx" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="18" cy="5" r="3"/>
                            <circle cx="6" cy="12" r="3"/>
                            <circle cx="18" cy="19" r="3"/>
            ...
            <article class="document-card" data-category="image" data-search="rodni list jpg slika" data-name="Rodni list" data-size="2400" data-date="20260615">
                ...
                <div class="file-main">
                    <div class="title-row">
                        <strong>Rodni list.jpg</strong>
                    </div>
                    <div class="meta">
                        <span>JPG</span>
                        <span>2,4 MB</span>
                        <span>15. lipnja 2026.</span>
                    </div>
                </div>

                <div class="card-actions">
                    <button class="icon-button" type="button" onclick="showToast('Otvoren pregled slike.')" aria-label="Pregled">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
                    </button>
                    <button class="icon-button share-trigger" type="button" data-item="Rodni list.jpg" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="18" cy="5" r="3"/>
                            <circle cx="6" cy="12" r="3"/>
                            <circle cx="18" cy="19" r="3"/>
            ...
            <article class="document-card" data-category="other" data-search="medicinska dokumentacija zip nalazi" data-name="Medicinska dokumentacija" data-size="14800" data-date="20260602">
                ...
                <div class="file-main">
                    <div class="title-row">
                        <strong>Medicinska dokumentacija.zip</strong>
                        <span class="shared-badge">Podijeljeno</span>
                    </div>
                    <div class="meta">
                        <span>ZIP</span>
                        <span>14,8 MB</span>
                        <span>2. lipnja 2026.</span>
                    </div>
                </div>

                <div class="card-actions">
                    <button class="icon-button" type="button" onclick="showToast('Pokrenuto preuzimanje arhive.')" aria-label="Preuzmi">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 3v12"/>
                            <path d="m7 10 5 5 5-5"/>
                            <path d="M5 21h14"/>
                    ...
                    <button class="icon-button share-trigger" type="button" data-item="Medicinska dokumentacija.zip" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="18" cy="5" r="3"/>
                            <circle cx="6" cy="12" r="3"/>
                            <circle cx="18" cy="19" r="3"/>
            ...
            <article class="document-card" data-category="pdf" data-search="izvadak iz matice rođenih pdf" data-name="Izvadak iz matice rođenih" data-size="960" data-date="20260518">
                <div class="file-icon">
                    <svg width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M7 3h7l4 4v14H7z"/>
                        <path d="M14 3v5h5"/>
                ...
                <div class="file-main">
                    <div class="title-row">
                        <strong>Izvadak iz matice rođenih.pdf</strong>
                    </div>
                    <div class="meta">
                        <span>PDF</span>
                        <span>960 KB</span>
                        <span>18. svibnja 2026.</span>
                    </div>
                </div>
                ...
                <div class="card-actions">
                    ...
                    <button class="icon-button share-trigger" type="button" data-item="Izvadak iz matice rođenih.pdf" aria-label="Podijeli">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="18" cy="5" r="3"/>
                            <circle cx="6" cy="12" r="3"/>
                            <circle cx="18" cy="19" r="3"/>
...
@push('scripts')
    <script>
        ...
        function showToast(message) {
            if (message === 'Otvoreno uređivanje dokumenta.') {
                window.location.href = @json(route('dokumenti.edit'));
                return;
            }
