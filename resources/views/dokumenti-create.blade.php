...
@section('content')
    <section class="page-heading">
        <div class="page-heading-copy">
            ...
            <p>Unesi osnovne podatke i priloži datoteku koju želiš spremiti u svoj trezor.</p>
        </div>
    ...
    <form id="documentCreateForm" method="POST" action="{{ route('dokumenti.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-card">
            <section class="form-section">
                <div class="section-title section-title-row">
                    <div>
                        ...
                        <p>Podaci koji će se prikazivati na stranici dokumenata i u pretrazi.</p>
                    </div>

                    <button class="icon-button" type="button" aria-label="Podijeli dokument" onclick="showToast('Podjela je dostupna nakon spremanja dokumenta.')">
            ...
            <section class="form-section">
                <div class="section-title">
                    <h2>Datoteka</h2>
                    <p>Odaberi datoteku koju želiš pohraniti u dokumente.</p>
                </div>
                ...
                <div class="file-card">
                    <div class="file-main">
                        ...
                        <div class="file-copy">
                            <strong id="fileName">Nema odabrane datoteke</strong>
                            <span id="fileMeta">PDF, DOCX, JPG ili PNG</span>
                            <span>Datoteka će biti spremljena nakon potvrde forme.</span>
                        </div>
                    </div>

                    <div class="file-actions">
                        <button class="secondary-button" type="button" id="previewButton">Pregled</button>
                        <button class="secondary-button" type="button" id="replaceButton">Odaberi datoteku</button>
                    </div>
                </div>
        ...
        <div class="form-actions">
            ...
            <button class="primary-button" type="submit">Spremi dokument</button>
        </div>
    </form>
@endsection
...
@push('scripts')
    <script>
        ...
        document.getElementById('previewButton').addEventListener('click', () => {
            showToast('Nema datoteke za pregled.');
        });
        ...
        fileInput.addEventListener('change', () => {
            ...
            showToast('Datoteka je odabrana.');
        });
