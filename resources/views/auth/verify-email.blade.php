<x-guest-layout
    ...
    subtitle="Provjeri inbox i potvrdi email adresu kako bi aktivirao račun."
    link-label="Trebaš drugi račun?"
    link-text="Prijavi se"
    :link-url="route('login')"
>
    <div class="auth-note">
        Hvala na registraciji. Nakon potvrde email adrese možeš se prijaviti. Ako poruka nije stigla, zatraži novu poveznicu.
    </div>
